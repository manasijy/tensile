...
savefig(h(1),fullfile(foldername,'StressDrop.fig'));%'StressDrop.fig');
savefig(h(2),fullfile(foldername,'StressDropHistogram.fig'));%'StressDrop.fig');
save(saveLocation,'SDrop_x','SDrop_y','StressDrop_significant');
